# Allocator Benchmark Audit — improved_phaseuu_tt1_budget_aware_lighter_both
...
candidate:improved_phaseuu_tt1_budget_aware_lighter_both      0.0698   0.0785  0.8891       -0.1408 -0.0264  0.4961        0.0578         0.0008
```

## Risk Contribution — improved_phaseuu_tt1_budget_aware_lighter_both

```
                      sleeve  avg_dollar_weight  avg_risk_contribution  risk_contribution_pct  risk_minus_dollar_weight_pct
composite_regime_conditioned             0.2394                 0.0000                 0.3835                        0.1441
                 taa_10m_sma             0.1395                 0.0000                 0.3365                        0.1970
