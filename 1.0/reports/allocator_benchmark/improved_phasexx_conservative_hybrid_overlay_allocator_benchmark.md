# Allocator Benchmark Audit — improved_phasexx_conservative_hybrid_overlay
...
candidate:improved_phasexx_conservative_hybrid_overlay      0.0701   0.0787  0.8897       -0.1408 -0.0264  0.4977        0.0577         0.0008
```

## Risk Contribution — improved_phasexx_conservative_hybrid_overlay

```
                      sleeve  avg_dollar_weight  avg_risk_contribution  risk_contribution_pct  risk_minus_dollar_weight_pct
composite_regime_conditioned             0.2394                 0.0000                 0.3823                        0.1429
                 taa_10m_sma             0.1401                 0.0000                 0.3372                        0.1971
          dual_momentum_topn             0.1115                 0.0000                 0.2805                        0.1690
```
...
- `dual_momentum_topn`: dollar weight 11.2% but risk contribution 28.0% (delta +16.9pp).
