# Research Committee Audit — improved_phaseccc_confirmed_cap_dual
...
- New portfolio version `improved_phaseccc_confirmed_cap_dual` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseccc_confirmed_cap_dual (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseccc_confirmed_cap_dual (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                       0.0714                                           0.0689      0.0025                                          0.1464                                              0.1243         0.0221
     ann_vol                                       0.0761                                           0.0779     -0.0018                                          0.0806                                              0.0765         0.0041
      sharpe                                       0.9376                                           0.8848      0.0528                                          1.8157                                              1.6249         0.1908
max_drawdown                                      -0.1175                                          -0.1398      0.0223                                         -0.0728                                             -0.0626        -0.0102
      cvar_5                                      -0.0253                                          -0.0262      0.0009                                         -0.0221                                             -0.0210        -0.0011
      calmar                                       0.6075                                           0.4932      0.1143                                          2.0108                                              1.9850         0.0258
```

## Bull Case

- Full-window Sharpe **0.938** vs production **0.885** (Δ +0.053).
- Holdout (last 156w) Sharpe **1.816** vs production **1.625** (Δ +0.191).
...
- holdout raw return delta vs production: +2.21pp
- holdout sharpe delta vs production: +0.191 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1228 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 26.68% vs 28.39%
- avg SPY exposure (cand vs prod): 6.06% vs 7.08%
...
See `reports/backtest_realism/improved_phaseccc_confirmed_cap_dual_realism_audit.md` for cost / delay / turnover / liquidity sensitivities.

## Allocator Benchmark Summary (Layer 6 hand-off)

See `reports/allocator_benchmark/improved_phaseccc_confirmed_cap_dual_allocator_benchmark.md` for EW / IV / ERC / HRP comparisons.
