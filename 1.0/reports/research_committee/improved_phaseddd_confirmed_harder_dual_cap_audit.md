# Research Committee Audit — improved_phaseddd_confirmed_harder_dual_cap
...
- New portfolio version `improved_phaseddd_confirmed_harder_dual_cap` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseddd_confirmed_harder_dual_cap (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseddd_confirmed_harder_dual_cap (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                              0.0714                                           0.0689      0.0025                                                 0.1461                                              0.1243         0.0218
     ann_vol                                              0.0762                                           0.0779     -0.0017                                                 0.0807                                              0.0765         0.0042
      sharpe                                              0.9379                                           0.8848      0.0531                                                 1.8115                                              1.6249         0.1866
max_drawdown                                             -0.1175                                          -0.1398      0.0223                                                -0.0728                                             -0.0626        -0.0101
      cvar_5                                             -0.0253                                          -0.0262      0.0009                                                -0.0221                                             -0.0210        -0.0011
      calmar                                              0.6080                                           0.4932      0.1148                                                 2.0077                                              1.9850         0.0228
```

## Bull Case

- Full-window Sharpe **0.938** vs production **0.885** (Δ +0.053).
- Holdout (last 156w) Sharpe **1.811** vs production **1.625** (Δ +0.187).
...
- holdout sharpe delta vs production: +0.187 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1234 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 26.73% vs 28.39%
- avg SPY exposure (cand vs prod): 6.04% vs 7.08%
...
recovery_confirmed       44          0.0005          0.0005          -0.0001         0.0103         0.0093
```
...
_Layer 5 realism report not yet produced for `improved_phaseddd_confirmed_harder_dual_cap`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseddd_confirmed_harder_dual_cap`._
