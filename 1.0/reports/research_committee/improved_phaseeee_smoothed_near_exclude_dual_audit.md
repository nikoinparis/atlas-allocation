# Research Committee Audit — improved_phaseeee_smoothed_near_exclude_dual
...
- New portfolio version `improved_phaseeee_smoothed_near_exclude_dual` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseeee_smoothed_near_exclude_dual (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseeee_smoothed_near_exclude_dual (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                               0.0713                                           0.0689      0.0023                                                  0.1463                                              0.1243         0.0219
     ann_vol                                               0.0762                                           0.0779     -0.0017                                                  0.0804                                              0.0765         0.0039
      sharpe                                               0.9353                                           0.8848      0.0505                                                  1.8198                                              1.6249         0.1949
max_drawdown                                              -0.1177                                          -0.1398      0.0220                                                 -0.0725                                             -0.0626        -0.0099
      cvar_5                                              -0.0254                                          -0.0262      0.0008                                                 -0.0220                                             -0.0210        -0.0010
      calmar                                               0.6053                                           0.4932      0.1122                                                  2.0166                                              1.9850         0.0316
```

## Bull Case

- Full-window Sharpe **0.935** vs production **0.885** (Δ +0.050).
- Holdout (last 156w) Sharpe **1.820** vs production **1.625** (Δ +0.195).
...
- holdout raw return delta vs production: +2.19pp
- holdout sharpe delta vs production: +0.195 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1230 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 26.65% vs 28.39%
...
recovery_confirmed       44          0.0005          0.0005          -0.0001         0.0102         0.0093
```
...
_Layer 5 realism report not yet produced for `improved_phaseeee_smoothed_near_exclude_dual`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseeee_smoothed_near_exclude_dual`._
