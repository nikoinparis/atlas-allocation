# Research Committee Audit — improved_phaseff_hint_inallocator_light
...
- New portfolio version `improved_phaseff_hint_inallocator_light` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseff_hint_inallocator_light (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseff_hint_inallocator_light (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                          0.0686                                           0.0689     -0.0003                                             0.1247                                              0.1243         0.0003
     ann_vol                                          0.0781                                           0.0779      0.0002                                             0.0767                                              0.0765         0.0002
      sharpe                                          0.8789                                           0.8848     -0.0059                                             1.6253                                              1.6249         0.0004
max_drawdown                                         -0.1408                                          -0.1398     -0.0011                                            -0.0622                                             -0.0626         0.0005
      cvar_5                                         -0.0263                                          -0.0262     -0.0001                                            -0.0211                                             -0.0210        -0.0001
      calmar                                          0.4872                                           0.4932     -0.0060                                             2.0050                                              1.9850         0.0200
```

## Bull Case

- Holdout (last 156w) Sharpe **1.625** vs production **1.625** (Δ +0.000).
...
_Layer 5 realism report not yet produced for `improved_phaseff_hint_inallocator_light`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseff_hint_inallocator_light`._
