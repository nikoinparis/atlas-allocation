# Research Committee Audit — improved_phaseii_good_state_participation_light
...
- New portfolio version `improved_phaseii_good_state_participation_light` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseii_good_state_participation_light (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseii_good_state_participation_light (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                                  0.0691                                           0.0689      0.0002                                                     0.1244                                              0.1243         0.0001
     ann_vol                                                  0.0781                                           0.0779      0.0002                                                     0.0769                                              0.0765         0.0003
      sharpe                                                  0.8853                                           0.8848      0.0004                                                     1.6186                                              1.6249        -0.0063
max_drawdown                                                 -0.1398                                          -0.1398     -0.0000                                                    -0.0626                                             -0.0626         0.0000
      cvar_5                                                 -0.0262                                          -0.0262     -0.0001                                                    -0.0212                                             -0.0210        -0.0002
      calmar                                                  0.4944                                           0.4932      0.0013                                                     1.9859                                              1.9850         0.0009
```
...
- holdout sharpe delta vs production: -0.006 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1125 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 28.23% vs 28.39%
- avg SPY exposure (cand vs prod): 7.10% vs 7.08%
...
_Layer 5 realism report not yet produced for `improved_phaseii_good_state_participation_light`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseii_good_state_participation_light`._
