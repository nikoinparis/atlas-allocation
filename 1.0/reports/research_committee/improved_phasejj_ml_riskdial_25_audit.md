# Research Committee Audit — improved_phasejj_ml_riskdial_25
...
- New portfolio version `improved_phasejj_ml_riskdial_25` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phasejj_ml_riskdial_25 (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phasejj_ml_riskdial_25 (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                  0.0692                                           0.0689      0.0003                                     0.1249                                              0.1243         0.0006
     ann_vol                                  0.0783                                           0.0779      0.0004                                     0.0773                                              0.0765         0.0007
      sharpe                                  0.8837                                           0.8848     -0.0012                                     1.6174                                              1.6249        -0.0075
max_drawdown                                 -0.1418                                          -0.1398     -0.0020                                    -0.0628                                             -0.0626        -0.0001
      cvar_5                                 -0.0263                                          -0.0262     -0.0001                                    -0.0213                                             -0.0210        -0.0002
      calmar                                  0.4881                                           0.4932     -0.0051                                     1.9904                                              1.9850         0.0054
```
...
- holdout raw return delta vs production: +0.06pp
- holdout sharpe delta vs production: -0.008 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1128 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 28.11% vs 28.39%
- avg SPY exposure (cand vs prod): 7.11% vs 7.08%
...
_Layer 5 realism report not yet produced for `improved_phasejj_ml_riskdial_25`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phasejj_ml_riskdial_25`._
