# Research Committee Audit — improved_phaseoo_composite_combined_cash_relief
...
- New portfolio version `improved_phaseoo_composite_combined_cash_relief` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseoo_composite_combined_cash_relief (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseoo_composite_combined_cash_relief (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                                  0.0693                                           0.0689      0.0004                                                     0.1250                                              0.1243         0.0007
     ann_vol                                                  0.0783                                           0.0779      0.0004                                                     0.0771                                              0.0765         0.0006
      sharpe                                                  0.8854                                           0.8848      0.0006                                                     1.6211                                              1.6249        -0.0038
max_drawdown                                                 -0.1405                                          -0.1398     -0.0007                                                    -0.0624                                             -0.0626         0.0003
      cvar_5                                                 -0.0263                                          -0.0262     -0.0001                                                    -0.0211                                             -0.0210        -0.0001
      calmar                                                  0.4933                                           0.4932      0.0001                                                     2.0038                                              1.9850         0.0189
```

## Bull Case

- Full-window Sharpe **0.885** vs production **0.885** (Δ +0.001).
...
- max drawdown delta vs production: -0.07pp (PASS; cap ≥ -1.0pp)
- CVaR-5% delta vs production: -0.01pp (PASS; cap ≥ -0.20pp)
- holdout raw return delta vs production: +0.07pp
- holdout sharpe delta vs production: -0.004 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1139 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 28.07% vs 28.39%
- avg SPY exposure (cand vs prod): 7.18% vs 7.08%
...
```
     ...
     neutral_mixed      493          0.0021          0.0021           0.0000         0.0105         0.0105
        calm_trend      295          0.0007          0.0008          -0.0000         0.0128         0.0128
...
_Layer 5 realism report not yet produced for `improved_phaseoo_composite_combined_cash_relief`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseoo_composite_combined_cash_relief`._
