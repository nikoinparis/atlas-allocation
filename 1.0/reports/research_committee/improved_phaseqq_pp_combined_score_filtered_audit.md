# Research Committee Audit — improved_phaseqq_pp_combined_score_filtered
...
- New portfolio version `improved_phaseqq_pp_combined_score_filtered` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseqq_pp_combined_score_filtered (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseqq_pp_combined_score_filtered (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                              0.0697                                           0.0689      0.0008                                                 0.1265                                              0.1243         0.0022
     ann_vol                                              0.0784                                           0.0779      0.0005                                                 0.0773                                              0.0765         0.0007
      sharpe                                              0.8886                                           0.8848      0.0038                                                 1.6376                                              1.6249         0.0127
max_drawdown                                             -0.1401                                          -0.1398     -0.0003                                                -0.0627                                             -0.0626        -0.0000
      cvar_5                                             -0.0264                                          -0.0262     -0.0002                                                -0.0212                                             -0.0210        -0.0001
      calmar                                              0.4975                                           0.4932      0.0043                                                 2.0186                                              1.9850         0.0336
```

## Bull Case

- Full-window Sharpe **0.889** vs production **0.885** (Δ +0.004).
- Holdout (last 156w) Sharpe **1.638** vs production **1.625** (Δ +0.013).
...
- holdout raw return delta vs production: +0.22pp
- holdout sharpe delta vs production: +0.013 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1152 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 27.68% vs 28.39%
...
_Layer 5 realism report not yet produced for `improved_phaseqq_pp_combined_score_filtered`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseqq_pp_combined_score_filtered`._
