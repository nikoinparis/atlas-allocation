# Research Committee Audit — improved_phaseww_confirmed_only_lighter_both
...
- New portfolio version `improved_phaseww_confirmed_only_lighter_both` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseww_confirmed_only_lighter_both (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseww_confirmed_only_lighter_both (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                               0.0699                                           0.0689      0.0009                                                  0.1279                                              0.1243         0.0035
     ann_vol                                               0.0786                                           0.0779      0.0007                                                  0.0777                                              0.0765         0.0012
      sharpe                                               0.8893                                           0.8848      0.0045                                                  1.6455                                              1.6249         0.0206
max_drawdown                                              -0.1408                                          -0.1398     -0.0010                                                 -0.0622                                             -0.0626         0.0005
      cvar_5                                              -0.0264                                          -0.0262     -0.0002                                                 -0.0210                                             -0.0210         0.0001
      calmar                                               0.4963                                           0.4932      0.0031                                                  2.0565                                              1.9850         0.0715
```

## Bull Case

- Full-window Sharpe **0.889** vs production **0.885** (Δ +0.004).
- Holdout (last 156w) Sharpe **1.646** vs production **1.625** (Δ +0.021).
...
- holdout sharpe delta vs production: +0.021 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1156 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 28.31% vs 28.39%
...
_Layer 5 realism report not yet produced for `improved_phaseww_confirmed_only_lighter_both`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseww_confirmed_only_lighter_both`._
