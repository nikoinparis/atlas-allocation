# Research Committee Audit — improved_phasexx_conservative_hybrid_overlay
...
- New portfolio version `improved_phasexx_conservative_hybrid_overlay` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phasexx_conservative_hybrid_overlay (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phasexx_conservative_hybrid_overlay (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                               0.0701                                           0.0689      0.0011                                                  0.1278                                              0.1243         0.0035
     ann_vol                                               0.0787                                           0.0779      0.0008                                                  0.0780                                              0.0765         0.0015
      sharpe                                               0.8897                                           0.8848      0.0049                                                  1.6390                                              1.6249         0.0141
max_drawdown                                              -0.1408                                          -0.1398     -0.0010                                                 -0.0622                                             -0.0626         0.0005
      cvar_5                                              -0.0264                                          -0.0262     -0.0003                                                 -0.0211                                             -0.0210        -0.0001
      calmar                                               0.4977                                           0.4932      0.0045                                                  2.0555                                              1.9850         0.0705
```
...
- holdout raw return delta vs production: +0.35pp
- holdout sharpe delta vs production: +0.014 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1153 vs 0.1124
...
_Layer 5 realism report not yet produced for `improved_phasexx_conservative_hybrid_overlay`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phasexx_conservative_hybrid_overlay`._
