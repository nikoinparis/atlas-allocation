...
ALL_VERSIONS = FIXED_COMPARATOR_SET + PHASE_K_CANDIDATES
...
def main() -> None:
    ...
    full_df.to_csv(LAYER3_DIR / "phase_k_candidate_metrics_full.csv", index=False)
    dev_df.to_csv(LAYER3_DIR / "phase_k_candidate_metrics_dev.csv", index=False)
    holdout_df.to_csv(LAYER3_DIR / "phase_k_candidate_metrics_holdout.csv", index=False)
    rolling_df.to_csv(LAYER3_DIR / "phase_k_rolling_origin_summary.csv", index=False)
    pairwise_df.to_csv(LAYER3_DIR / "phase_k_pairwise_validation.csv", index=False)

    protocol = {
        "phase": "Phase K",
        "purpose": "Robustness-aware allocator framework validation",
    ...
    (LAYER3_DIR / "phase_k_validation_protocol.json").write_text(json.dumps(protocol, indent=2))

    print("Saved Phase K evaluation artifacts:")
    for name in [
        "data/05_layer3_portfolio_construction/phase_k_candidate_metrics_full.csv",
        "data/05_layer3_portfolio_construction/phase_k_candidate_metrics_dev.csv",
        "data/05_layer3_portfolio_construction/phase_k_candidate_metrics_holdout.csv",
        "data/05_layer3_portfolio_construction/phase_k_rolling_origin_summary.csv",
        "data/05_layer3_portfolio_construction/phase_k_pairwise_validation.csv",
        "data/05_layer3_portfolio_construction/phase_k_validation_protocol.json",
    ]:
        print(" -", name)
