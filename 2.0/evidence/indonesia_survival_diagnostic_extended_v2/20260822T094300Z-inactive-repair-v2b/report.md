# Indonesia Strategy Survival Diagnostic

> **RESEARCH ONLY — independent inactive-security price supplement and stale-price exclusion; not an investment recommendation or authorized performance claim.**

## Verdict: INCONCLUSIVE_DATA_GATED

The strategy has 91 monthly decisions versus the
predeclared minimum of 60.
...
|---|---:|---:|---:|---:|
| Strategy, net 50 bps one-way | 2.40% | 21.69% | 0.22 | -46.00% |
| Strategy, net 150 bps one-way | -2.18% | 21.78% | 0.01 | -48.37% |
| Equal-weight eligible IDX80, net 50 bps | -0.10% | 21.64% | 0.10 | -52.80% |
| IHSG price index | -0.09% | 17.81% | 0.08 | -41.17% |
| LQ45 price index | -6.72% | 21.75% | -0.21 | -51.23% |

The base-cost comparison gates currently read: CAGR above IHSG **True**,
CAGR above LQ45 **True**, Sharpe above IHSG
**True**, and Sharpe above LQ45
**True**. Against equal weight, the CAGR hurdle is
**True** and the Sharpe hurdle is
**True**. These are diagnostic observations, not
a pass, recommendation, or expected return.

## Binding limitations

- Pre-2024 membership is reconstructed evidence, not a complete direct IDX download.
- SRIL and WSKT are supplemented from an independently archived university dataset and excluded after 10 stale calendar days; complete suspension exits and delisting returns remain unavailable.
