...
OUTPUT = ROOT / "evidence/dashboard_strategy_survival_lab_v2"
SEAL = OUTPUT / "execution_seal.json"
FILES = [
    ROOT / "config/dashboard_strategy_survival_lab_v2.json",
    ROOT / "scripts/run_dashboard_strategy_survival_lab_v2.py",
    ROOT / "scripts/seal_dashboard_strategy_survival_lab_v2.py",
    ROOT / "tests/test_dashboard_strategy_survival_lab_v2.py",
...
def main() -> int:
    ...
    payload = {
        "experiment": "dashboard_strategy_survival_lab_v2",
