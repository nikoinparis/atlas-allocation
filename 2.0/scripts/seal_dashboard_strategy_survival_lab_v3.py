...
FILES = [
    ROOT / "config/dashboard_strategy_survival_lab_v3.json",
    ROOT / "scripts/run_dashboard_strategy_survival_lab_v3.py",
    ROOT / "scripts/seal_dashboard_strategy_survival_lab_v3.py",
    ROOT / "tests/test_dashboard_strategy_survival_lab_v3.py",
...
def main() -> int:
    ...
    payload = {
        "experiment": "dashboard_strategy_survival_lab_v3",
