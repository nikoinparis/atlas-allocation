...
INPUTS = [
    ROOT / "config/sec_cross_strategy_residual_allocator_v3.json",
    ROOT / "dashboard/public/return-first-dashboard.json",
    ROOT / "data/cross_strategy_concentration_map_v2/sector_map.csv",
    ROOT / "data/cross_strategy_concentration_map_v2/manifest.json",
    ROOT / "scripts/run_sec_cross_strategy_residual_allocator_v3.py",
]
