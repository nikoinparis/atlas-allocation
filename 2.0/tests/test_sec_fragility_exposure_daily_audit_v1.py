...
CONFIG = json.loads((ROOT / "config/sec_fragility_exposure_daily_audit_v1.json").read_text())
SPEC = importlib.util.spec_from_file_location("daily_audit", ROOT / "scripts/run_sec_fragility_exposure_daily_audit_v1.py")
