# Allocator Benchmark Audit — improved_phasenn_mm_plus_lookthrough_relief
...
candidate:improved_phasenn_mm_plus_lookthrough_relief      0.0691   0.0780  0.8851       -0.1399 -0.0262  0.4938        0.0569         0.0007
```

## Risk Contribution — improved_phasenn_mm_plus_lookthrough_relief

```
                      sleeve  avg_dollar_weight  avg_risk_contribution  risk_contribution_pct  risk_minus_dollar_weight_pct
composite_regime_conditioned             0.2549                 0.0000                 0.4091                        0.1542
                 taa_10m_sma             0.1352                 0.0000                 0.3221                        0.1870
          dual_momentum_topn             0.1074                 0.0000                 0.2688                        0.1613
```

**Hidden concentration flagged:**
- `composite_regime_conditioned`: dollar weight 25.5% but risk contribution 40.9% (delta +15.4pp).
