# Research Committee Audit — improved_phasejj_ml_riskdial_50
...
- New portfolio version `improved_phasejj_ml_riskdial_50` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phasejj_ml_riskdial_50 (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phasejj_ml_riskdial_50 (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                  0.0696                                           0.0689      0.0007                                     0.1257                                              0.1243         0.0013
     ann_vol                                  0.0788                                           0.0779      0.0009                                     0.0779                                              0.0765         0.0013
      sharpe                                  0.8827                                           0.8848     -0.0021                                     1.6140                                              1.6249        -0.0109
max_drawdown                                 -0.1448                                          -0.1398     -0.0051                                    -0.0628                                             -0.0626        -0.0002
      cvar_5                                 -0.0265                                          -0.0262     -0.0003                                    -0.0214                                             -0.0210        -0.0004
      calmar                                  0.4805                                           0.4932     -0.0127                                     1.9993                                              1.9850         0.0143
```
...
- max drawdown delta vs production: -0.51pp (PASS; cap ≥ -1.0pp)
- CVaR-5% delta vs production: -0.03pp (PASS; cap ≥ -0.20pp)
- holdout raw return delta vs production: +0.13pp
- holdout sharpe delta vs production: -0.011 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1129 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 27.77% vs 28.39%
- avg SPY exposure (cand vs prod): 7.13% vs 7.08%
...
_Layer 5 realism report not yet produced for `improved_phasejj_ml_riskdial_50`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phasejj_ml_riskdial_50`._
