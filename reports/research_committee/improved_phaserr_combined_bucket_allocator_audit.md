# Research Committee Audit — improved_phaserr_combined_bucket_allocator
...
- New portfolio version `improved_phaserr_combined_bucket_allocator` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaserr_combined_bucket_allocator (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaserr_combined_bucket_allocator (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                             0.0698                                           0.0689      0.0009                                                0.1270                                              0.1243         0.0026
     ann_vol                                             0.0790                                           0.0779      0.0011                                                0.0786                                              0.0765         0.0021
      sharpe                                             0.8843                                           0.8848     -0.0005                                                1.6154                                              1.6249        -0.0095
max_drawdown                                            -0.1438                                          -0.1398     -0.0040                                               -0.0619                                             -0.0626         0.0007
      cvar_5                                            -0.0266                                          -0.0262     -0.0004                                               -0.0217                                             -0.0210        -0.0007
      calmar                                             0.4857                                           0.4932     -0.0074                                                2.0503                                              1.9850         0.0653
```
...
- max drawdown delta vs production: -0.40pp (PASS; cap ≥ -1.0pp)
- CVaR-5% delta vs production: -0.04pp (PASS; cap ≥ -0.20pp)
- holdout raw return delta vs production: +0.26pp
- holdout sharpe delta vs production: -0.010 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1130 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 27.84% vs 28.39%
...
```
    ...
    stressed_panic      229          0.0007          0.0007          -0.0000         0.0096         0.0094
  recovery_fragile       49          0.0014          0.0013           0.0001         0.0074         0.0073
...
_Layer 5 realism report not yet produced for `improved_phaserr_combined_bucket_allocator`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaserr_combined_bucket_allocator`._
