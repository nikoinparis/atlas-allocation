# Research Committee Audit — improved_phaseuu_tt1_budget_aware_lighter_both
...
- New portfolio version `improved_phaseuu_tt1_budget_aware_lighter_both` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phaseuu_tt1_budget_aware_lighter_both (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phaseuu_tt1_budget_aware_lighter_both (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                                 0.0698                                           0.0689      0.0009                                                    0.1278                                              0.1243         0.0034
     ann_vol                                                 0.0785                                           0.0779      0.0007                                                    0.0776                                              0.0765         0.0011
      sharpe                                                 0.8891                                           0.8848      0.0043                                                    1.6453                                              1.6249         0.0204
max_drawdown                                                -0.1408                                          -0.1398     -0.0010                                                   -0.0622                                             -0.0626         0.0005
      cvar_5                                                -0.0264                                          -0.0262     -0.0002                                                   -0.0210                                             -0.0210         0.0001
      calmar                                                 0.4961                                           0.4932      0.0029                                                    2.0547                                              1.9850         0.0698
```
...
- avg weekly L1 turnover (cand vs prod): 0.1155 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 28.33% vs 28.39%
...
_Layer 5 realism report not yet produced for `improved_phaseuu_tt1_budget_aware_lighter_both`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phaseuu_tt1_budget_aware_lighter_both`._
