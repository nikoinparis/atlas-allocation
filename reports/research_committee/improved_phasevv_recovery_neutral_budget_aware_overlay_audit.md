# Research Committee Audit — improved_phasevv_recovery_neutral_budget_aware_overlay
...
- New portfolio version `improved_phasevv_recovery_neutral_budget_aware_overlay` produced under the project's existing 5bp half-spread cost convention and last-Friday rebalance schedule.
...
```
      metric  improved_phasevv_recovery_neutral_budget_aware_overlay (full)  improved_phase2b_regime_confidence_boost (full)  delta_full  improved_phasevv_recovery_neutral_budget_aware_overlay (holdout)  improved_phase2b_regime_confidence_boost (holdout)  delta_holdout
  ann_return                                                         0.0701                                           0.0689      0.0011                                                            0.1278                                              0.1243         0.0034
     ann_vol                                                         0.0787                                           0.0779      0.0008                                                            0.0780                                              0.0765         0.0014
      sharpe                                                         0.8898                                           0.8848      0.0050                                                            1.6389                                              1.6249         0.0140
max_drawdown                                                        -0.1408                                          -0.1398     -0.0010                                                           -0.0622                                             -0.0626         0.0005
      cvar_5                                                        -0.0264                                          -0.0262     -0.0003                                                           -0.0211                                             -0.0210        -0.0001
      calmar                                                         0.4977                                           0.4932      0.0045                                                            2.0550                                              1.9850         0.0700
```

## Bull Case

- Full-window Sharpe **0.890** vs production **0.885** (Δ +0.005).
- Holdout (last 156w) Sharpe **1.639** vs production **1.625** (Δ +0.014).
...
- holdout raw return delta vs production: +0.34pp
- holdout sharpe delta vs production: +0.014 (PASS; cap ≥ -0.02)
- avg weekly L1 turnover (cand vs prod): 0.1154 vs 0.1124
- avg BIL/cash exposure (cand vs prod): 28.17% vs 28.39%
- avg SPY exposure (cand vs prod): 7.34% vs 7.08%
...
```
    ...
    stressed_panic      229          0.0007          0.0007          -0.0000         0.0095         0.0094
  recovery_fragile       49          0.0015          0.0013           0.0002         0.0074         0.0073
recovery_confirmed       44          0.0007          0.0005           0.0001         0.0098         0.0093
```
...
_Layer 5 realism report not yet produced for `improved_phasevv_recovery_neutral_budget_aware_overlay`._

## Allocator Benchmark Summary (Layer 6 hand-off)

_Layer 6 allocator benchmark not yet produced for `improved_phasevv_recovery_neutral_budget_aware_overlay`._
